                ...
                case 1:
                    ...
                    for (int i = 0; i < carLot.capacity(); i++) {
                        if (carLot.get(i) != null)
                            System.out.printf("  %2d   | %6s  |  %4s\n", i, carLot.get(i).getColor(), carLot.get(i).getMake());
                    ...
                    System.out.println();
                    Vehicle newCar = carLot.remove(choice);
                    if (newCar == null) {
                        System.out.println("There is no car at Spot " + choice + ", sorry!");
                    } else {
                        System.out.println("A " + newCar.getColor() + " " + newCar.getMake() + " has been removed from the lot");
                    }
                    break;
